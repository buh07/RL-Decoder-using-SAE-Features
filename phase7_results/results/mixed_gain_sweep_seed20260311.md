...
- Run tag: `mixed_gain_sweep_seed20260311`
- Final decision: `mixed_redundant_or_insufficient`
- Delta AUROC M3-M1 (wrong_intermediate): `0.0625`
- Delta CI95: `-0.125` .. `0.375`
- Practical effect pass: `False`
- CV pooled M3 wrong_intermediate AUROC: `0.6035665294924554`
- CV pooled M3 CI95: `0.5157750342935528` .. `0.6899862825788752`
